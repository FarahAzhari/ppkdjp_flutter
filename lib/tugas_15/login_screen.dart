...
import 'package:ppkdjp_flutter/tugas_15/models/error_response_model.dart';
import 'package:ppkdjp_flutter/tugas_15/profile_screen.dart';
import 'package:ppkdjp_flutter/tugas_15/register_screen.dart';
import 'package:ppkdjp_flutter/tugas_15/services/api_service.dart';
import 'package:ppkdjp_flutter/tugas_15/social_login_buttons.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                TextFormField(
                  ...
                  onChanged:
                      (_) => _clearError('email'), // Clear error on change
                ...
                TextFormField(
                  ...
                  onChanged:
                      (_) => _clearError('password'), // Clear error on change
                  decoration: InputDecoration(
